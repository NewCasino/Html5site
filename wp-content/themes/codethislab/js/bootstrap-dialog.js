...
(function(root, factory) {
    ...
    BootstrapDialog.prototype = {
        ...
        createCloseButton: function() {
            ...
            var $icon = $('<button class="cart-button"><i class="fa fa-close"></i></button>');
        ...
        createButton: function(button) {
            var $button = $('<button class="cart-button"></button>');
            ...
            // Disabled
            if (typeof button.disabled !== 'undefined' && $.trim(button.disabled) !== '') {
                if(button.disabled  == true){
                    $button.prop("disabled", true).toggleClass('disabled', true);
                }
            }
